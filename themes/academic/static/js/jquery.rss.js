(function ($) {
  ...
  var RSS = function (target, url, options, callback) {
    ...
    this.options = $.extend({
	  ...
	  // HERE YOU CAN CHOOSE HOW TO SHOW AUTHOR AND DATE.    entryTemplate: '<li><a href="{url}">[{author}@{date}] {title}</a><br/>{shortBodyPlain}</li>', 
      entryTemplate: '<li><a href="{url}" target="_blank" > {title}</a><br/></li>', 
      tokens: {},
      outputMode: 'json',
